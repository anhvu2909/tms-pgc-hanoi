...
// Luồng 5 trạng thái rút gọn — chốt ở skill tu-dien-nghiep-vu-tms mục 4.
// Mã trạng thái giữ nguyên như hệ thống cũ để dữ liệu lịch sử vẫn đọc được.
export const trangThaiDonHang = {
  ...
  // --- Trạng thái cũ: chỉ còn ở dữ liệu lịch sử, KHÔNG chuyển đơn mới sang các
  // trạng thái này. Hiển thị màu xám, giữ nguyên tên gốc (theo skill mục 4). ---
  DA_TU_CHOI: {
    name: 'Từ chối',
    code: 'DA_TU_CHOI',
    color: '#A3A3A3',
...
// Action ghi vào lịch sử xử lý (sm_ActivityHistory."Action") — chốt ở skill
// tu-dien-nghiep-vu-tms mục 5. Đã bỏ các action thuộc luồng tài xế/giao nhận cũ
// (XacNhanGiaoHang, TuChoiGiaoHang, CapNhatGiaoNhan1/2/3, HoanThanhTrucTiep) —
// chúng chỉ còn xuất hiện trong LỊCH SỬ đơn hàng cũ, không dùng để tạo mới nữa.
export const actionDonHang = {
  TaoMoi: 'TaoMoi',
  GuiDuyet: 'GuiDuyet',
  PheDuyet: 'PheDuyet',
  TuChoi: 'TuChoi',
...
export const rightList: {
...
}[] = [
  {
    name: 'Xem',
    code: 'VIEW',
    property: 'isViewAllowed',
  },
  {
    name: 'Xem tất cả',
    code: 'VIEWALL',
    property: 'isViewAllAllowed',
  },
  {
    name: 'Thêm',
    code: 'ADD',
    property: 'isCreateAllowed',
  },
  {
    name: 'Cập nhật',
    code: 'UPDATE',
  ...
  },
  {
    name: 'Xóa',
    code: 'DELETE',
    property: 'isDeleteAllowed',
  },
  {
    name: 'Gửi duyệt',
    code: 'SEND_APPROVAL',
    property: 'isSendApprovalAllowed',
  },
  {
    name: 'Duyệt',
    code: 'APPROVE',
    property: 'isApproveAllowed',
  },
  {
    name: 'Phân xe - xế',
    code: 'ASSIGN_DELIVERY',
    property: 'isAssignDeliveryAllowed',
  },
  {
    name: 'Hủy',
    code: 'CANCEL',
    property: 'isCancelAllowed',
  },
  {
    name: 'Xác nhận giao',
    code: 'CONFIRM_DELIVERY',
    property: 'isConfirmDeliveryAllowed',
  },
  {
    name: 'Cập nhật DN',
    code: 'UPDATE_DN',
    property: 'isUpdateDNAllowed',
  },
  {
    name: 'Hoàn thành trực tiếp',
    code: 'COMPLETE_WITHOUT_DN',
    property: 'isCompleteWithoutDNAllowed',
  },
  {
    name: 'Hoàn tác',
    code: 'UNDO',
    property: 'isUndoAllowed',
  },
];
...
export const isPdfViewerEnabled = !!navigator.pdfViewerEnabled;
